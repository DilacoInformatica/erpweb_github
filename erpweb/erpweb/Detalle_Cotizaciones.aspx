    ...
    <div class="container-fluid rounded border border-secondary">
        <div class="container-fluid bg-light">
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <h4><asp:Label ID="lbl_numero_erp" runat="server" CssClass="form-control" Width="153px"></asp:Label></h4>
                </div>
                <div class="col-md-1">
                    <h4><span class="badge badge-info">Fecha</span></h4>
                </div>
                <div class="col-md-2">
                    <h4><asp:Label ID="lbl_fecha" runat="server" CssClass="form-control" Width="153px"></asp:Label></h4>
                </div>
                <div class="col-md-1">
                    <h4><span class="badge badge-info">N° OC</span></h4>
                </div>
                <div class ="col-md-2">
                    <h4><asp:Label ID="lbl_n_oc" runat="server" CssClass="form-control" Width="153px"></asp:Label></h4>
                </div>
            </div>
            <div class="row">
                <div class="col-md-1">
                ...
                <div class="col-md-2">
                    <h4><asp:Label ID="lbl_rut" CssClass="form-control" runat="server" BorderStyle="Groove" Width="153px"></asp:Label></h4>
            ...
            <div class="row">
             ...
             <div class="row">
                ...
                <div class="col-md-2">
                    <h4><asp:Label ID="lbl_fono" runat="server" CssClass="form-control" Width="252px"></asp:Label></h4>
                </div>
                <div class="col-md-1">
                    <h4><span class="badge badge-info col-form-label">Móvil</span></h4>
                </div>
                <div class="col-md-2">
                    <h4><asp:Label ID="lbl_movil" runat="server" CssClass="form-control" Width="252px"></asp:Label></h4>
                </div>
                <div class="col-md-1">
                    <h4><span class="badge badge-info col-form-label">Email</span></h4>
                </div>
                <div class="col-md-2">
                    <h4><asp:Label ID="lbl_email" runat="server" CssClass="form-control" Width="300px"></asp:Label></h4>
                </div>
            </div>
             <div class="row">
                <div class="col-md-1">
             ...
             <div class="row">
                ...
                <div class="col-md-2">
                    <h4><asp:TextBox ID="txt_comuna" runat="server" BackColor="#FFFFCC" CssClass="form-control" Width="250px"></asp:TextBox></h4>
                ...
                <div class="col-md-2">
                    <h4><asp:Label ID="lbl_ciudad" runat="server" CssClass="form-control" Width="250px"></asp:Label></h4>
                </div>
                <div class="col-md-1">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <h4>
                                <asp:Button ID="Btn_RechazarCot" CssClass="btn btn-md btn-danger active btn-block" runat="server" OnClick="Btn_RechazarCot_Click" Text="Rechazar Cotización" Width="261px" /></h4>
                        </div>
                        <div class="col-md-2">
                            <h4>
                                <asp:Button ID="Btn_crearCot" CssClass="btn btn-md btn-primary active btn-block" runat="server" OnClick="Btn_crearCot_Click" Text="Crear Cotización en ERP" Width="261px" /></h4>
                        </div>
                    </div>
                </div>
            </div>
