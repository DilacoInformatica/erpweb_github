...
<body>
   ...
   <div class="container-fluid rounded border border-secondary bg-light">
        <div class="row">
            ...
            <div class="col-md-4">
                <h5><span><asp:Label ID="lbl_error" runat="server" CssClass="badge badge-danger text-black-50"></asp:Label></span></h5>
            </div>
        </div>
    </div>
    <div class="container-fluid rounded border border-secondary bg-light">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                                <h5><asp:DropDownList ID="Lista_Vendedores" CssClass="form-control"  runat="server" AppendDataBoundItems="True">
                                    <asp:ListItem Value="0">Seleccione</asp:ListItem>
                                </asp:DropDownList></h5>
                        </div>
                        <div class="col-md-2">
