                    ...
                    <div class="row">
                        ...
                        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h4></span><asp:Label ID="lbl_error" runat="server" CssClass="badge bg-danger"></asp:Label></h4>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12 ">
                                   ...
                                   <div class="col-md-9">
                                       ...
                                       <div class="row">
                                           <div class="col-md-3">
                                               ...
                                               <asp:TextBox ID="txt_codigo" runat="server" Enabled="False" CssClass="form-control form-control-sm form-control form-control-sm-sm"></asp:TextBox>
                                           </div>
                                           <div class="col-md-9">
                                               <span class="badge bg-info"><span data-feather="edit"></span>Descripción</span>
                                                <asp:TextBox ID="txt_descripcion"  runat="server" CssClass="form-control form-control-sm"></asp:TextBox>
                                           </div>
                                       </div>
                                       <div class="row">
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="text-end">
                                                    <asp:TextBox ID="txt_precio_lista" runat="server" CssClass="form-control form-control-sm"></asp:TextBox>
                                                </div>
                                            </div>
                                           <div class="col-md-3">
                                                <span class="badge bg-info">Precio</span>
                                                <div class="text-end">
                                                    <asp:TextBox ID="txt_precio" runat="server" CssClass="form-control form-control-sm"></asp:TextBox>
                                                </div>
                                            </div>
                                           <div class="col-md-3">
                                                <span class="badge bg-info text-left">Multiplo</span>
                                                <asp:TextBox ID="txt_multiplo" runat="server" CssClass="form-control form-control-sm"></asp:TextBox>
                                            </div>
                                       </div>
                                       <div class="row">
                                            <div class="col-md-3">
                                                <span class="badge bg-info">Unidad de Venta</span>
                                                <asp:Label ID="lbl_unidad" runat="server" CssClass="form-control form-control-sm"></asp:Label>
                                            </div>
                                       ...
                                       <div class="row">
                                           <div class="col-md-3">
                                                ...
                                                <asp:TextBox ID="txt_marca" runat="server" CssClass="form-control form-control-sm"></asp:TextBox>
                                            </div>
                                            <div class="col-md-3">
                                                <span class="badge bg-info">Cod. Prov</span>
                                                <asp:TextBox ID="txt_codigoprov" runat="server" CssClass="form-control form-control-sm"></asp:TextBox>
                                            </div>
                                           <div class="col-md-6">
                                                <span class="badge bg-info input-group-prepend">Proveedor</span>
                                                <asp:TextBox ID="txt_proveedor" runat="server" Enabled="False" CssClass="form-control form-control-sm text-left"></asp:TextBox>
                                            </div>
                                       </div>
                                       <div class="row">
                                           <div class="col-md-3">
                                           ...
                                           <div class="col-md-3">
                                               ...
                                               <asp:CheckBox ID="Chk_crea_data" runat="server" TextAlign="Left" Visible="false" />
                                           </div>
                                           <div class="col-md-3">
                                                 <span class="badge bg-info">Pub. Sitio</span><br />
                                                <asp:Label ID="lbl_web" runat="server" CssClass="form-control form-control-sm"></asp:Label>
                                       ...
                                       <div class="row">
                                           <div class="col-md-3">
                                               <span class="badge bg-info">Activo</span><br />
                                                ...
                                                <asp:Label ID="lbl_activo" runat="server" CssClass="form-control form-control-sm" Width="40px"></asp:Label>
                                           </div>
                                           <div class="col-md-3">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <span class="badge bg-info input-group-prepend"><span data-feather="edit"></span>Texto Destacado</span>
                                         <asp:TextBox ID="txt_texto_destacado" runat="server" TextMode="MultiLine" Columns="6" CssClass="form-control form-control-sm"></asp:TextBox>
                                    </div>
                                </div>
                                    <p class="divider"></p>
                                 <div class="row">
                                    <div class="col-md-2">
                                        <span class="badge bg-info"><span data-feather="edit"></span>Características</span>
                                            <asp:ImageButton ID="ImgHTmlCar" CssClass="form-control form-control-sm" runat="server" Height="35px" ImageUrl="~/img/html.png" OnClick="ImgHTmlCar_Click" ViewStateMode="Enabled" Visible="False" Width="41px" />
                                        <asp:ImageButton ID="ImgVerCar" CssClass="form-control form-control-sm" runat="server" Height="35px" ImageUrl="~/img/vista.png" OnClick="ImgVerCar_Click" Visible="False" Width="41px" />
                                        <asp:ImageButton ID="ImgGrabaCar" CssClass="form-control form-control-sm" runat="server" Height="35px" ImageUrl="~/img/grabar.png" Visible="False" Width="41px" OnClick="ImgGrabaCar_Click1" />
                                    </div>
                                    <div class="col-md-10">
                                        <asp:TextBox ID="txt_caracteristicas" runat="server" TextMode="MultiLine" Columns="6" CssClass="form-control form-control-sm input-lg"></asp:TextBox>
                                        <asp:Label ID="lbl_caracteristicas" runat="server" BorderStyle="Groove" CssClass="form-control form-control-sm input-lg"></asp:Label>
                                    </div>
                                     <p class="divider"></p>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <asp:Label ID="lbl_manual_tecnico" CssClass="form-control form-control-sm" runat="server" BackColor="#CCCCCC"></asp:Label>
                                                <asp:FileUpload ID="File_FT" runat="server" CssClass="form-control form-control-sm" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <asp:Label ID="lbl_presentacion" CssClass="form-control form-control-sm" runat="server" BackColor="#CCCCCC"></asp:Label>
                                                <asp:FileUpload ID="File_PRE" runat="server" CssClass="form-control form-control-sm" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <asp:Label ID="lbl_fotog" runat="server" BackColor="#CCCCCC" CssClass="form-control form-control-sm"></asp:Label>
                                                <asp:FileUpload ID="File_FG" runat="server" CssClass="form-control form-control-sm" />                
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <asp:Label ID="lbl_fotoc" runat="server" BackColor="#CCCCCC" CssClass="form-control form-control-sm"></asp:Label>
                                                <asp:FileUpload ID="File_FC" runat="server" CssClass="form-control form-control-sm" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <asp:Label ID="lbl_video" runat="server" BackColor="#CCCCCC" CssClass="form-control form-control-sm"></asp:Label>
                                                <asp:FileUpload ID="File_VID" runat="server" CssClass="form-control form-control-sm" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <asp:Label ID="lbl_hoja_seguridad" runat="server" BackColor="#CCCCCC" CssClass="form-control form-control-sm"></asp:Label>
                                                <asp:FileUpload ID="File_HS" runat="server" CssClass="form-control form-control-sm" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <asp:TextBox ID="txt_acc1" runat="server" Enabled="False" CssClass="form-control form-control-sm"></asp:TextBox>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <asp:TextBox ID="txt_acc2" runat="server" Enabled="False" CssClass="form-control form-control-sm"></asp:TextBox>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <asp:TextBox ID="txt_acc3" runat="server" Enabled="False" CssClass="form-control form-control-sm"></asp:TextBox>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <asp:TextBox ID="txt_rep1" runat="server" Enabled="False" CssClass="form-control form-control-sm"></asp:TextBox>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <asp:TextBox ID="txt_rep2" runat="server" Enabled="False" CssClass="form-control form-control-sm"></asp:TextBox>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <asp:TextBox ID="txt_rep3" runat="server" Enabled="False" CssClass="form-control form-control-sm"></asp:TextBox>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <asp:TextBox ID="txt_alt1" runat="server" Enabled="False" CssClass="form-control form-control-sm"></asp:TextBox>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <asp:TextBox ID="txt_alt2" runat="server" Enabled="False" CssClass="form-control form-control-sm"></asp:TextBox>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <asp:TextBox ID="txt_alt3" runat="server" Enabled="False" CssClass="form-control form-control-sm"></asp:TextBox>
                            ...
                            <div class="container-fluid rounded border border-secondary">
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        ...
                                        <asp:ImageButton ID="ImgHTmltec" runat="server" Height="35px" ImageUrl="~/img/html.png" OnClick="ImgHTmlTec_Click" Visible="False" Width="41px" CssClass="form-control form-control-sm" />
                                        <asp:ImageButton ID="ImgVerTec" runat="server" Height="35px" ImageUrl="~/img/vista.png" OnClick="ImgVerTec_Click" Visible="False" Width="41px" CssClass="form-control form-control-sm" />
                                        <asp:ImageButton ID="ImgGrabaTec" runat="server" Height="35px" ImageUrl="~/img/grabar.png" OnClick="ImgGrabaTec_Click" Visible="False" Width="41px" CssClass="form-control form-control-sm" />
                                    </div>
                                    <div class="col-md-10">
                                        <asp:TextBox ID="txt_tabla_tecnica" runat="server" TextMode="MultiLine" CssClass="form-control form-control-sm input-lg"></asp:TextBox>
                                        <asp:Label ID="lbl_tabla_tecnica" runat="server" BorderStyle="Groove" CssClass="form-control form-control-sm input-lg"></asp:Label>
                                    </div>
                                </div>
                                <p class="divider"></p>
                            </div>
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h4>
                                            <asp:GridView ID="GridView1" CssClass="form-control form-control-sm" runat="server" Caption="Historial de Modificaciones" CellPadding="4" ForeColor="#333333" GridLines="None" ShowFooter="True" Width="1404px">
                                    ...
                                    <div class="col-md-12">
                                        <div class="row align-content-center">
                                            <div class="col-md-6 align-content-center">
                                                <asp:Button ID="Btn_emigrar" CssClass="form-control form-control-sm  btn-success" runat="server" Text="Subir/Actualizar Código al Sitio Web" OnClick="Btn_emigrar_Click" Width="308px" />
                                            </div>
                                            <div class="col-md-6 center">
                                                <asp:Button ID="Btn_eliminar" CssClass="form-control form-control-sm  btn-danger" runat="server" Text="Eliminar Código del Sitio Web" OnClick="Btn_eliminar_Click" Width="308px" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
