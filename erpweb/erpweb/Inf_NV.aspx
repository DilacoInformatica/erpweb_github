<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Inf_NV.aspx.cs" Inherits="erpweb.Inf_NV" %>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    ...
                    <asp:GridView ID="Lista_nv" CssClass="table table-striped table-hover" runat="server" ShowFooter="True" OnRowDataBound="Lista_nv_RowDataBound">
                        <Columns>
